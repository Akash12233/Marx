...
public:
    ...
    const FIX::fields::Account& getAccount() const { return account_; }
    void setAccount(const FIX::fields::Account& v) { account_ = v; }
    const FIX::fields::HandlInst& getHandlInst() const { return handlInst_; }
    void setHandlInst(const FIX::fields::HandlInst& v) { handlInst_ = v; }
    ...
    const FIX::fields::Currency& getCurrency() const { return currency_; }
    void setCurrency(const FIX::fields::Currency& v) { currency_ = v; }
    const FIX::fields::ExecInst& getExecInst() const { return execInst_; }
    void setExecInst(const FIX::fields::ExecInst& v) { execInst_ = v; }
    ...
    // reads NewOrderSingle::Meta below.
...
private:
    ...
    FIX::fields::Account account_;
    FIX::fields::HandlInst handlInst_;
    ...
    FIX::fields::Currency currency_;
    FIX::fields::ExecInst execInst_;
};
